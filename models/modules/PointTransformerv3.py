...
from models.modules.serialization import encode
...
class PointTransformerV3(PointModule):
    def __init__(
        ...
        enc_patch_size=(128, 128, 128, 128, 128), # 1024
        dec_depths=(2, 2, 2, 2),
        dec_channels=(64, 64, 128, 256),
        dec_num_head=(4, 4, 8, 16),
        dec_patch_size=(128, 128, 128, 128), # 1024
        mlp_ratio=4,
        qkv_bias=True,
        qk_scale=None,
        attn_drop=0.0,
    ...
    def forward(self, data_dict):
        ...
        if not self.cls_mode:
            point = self.dec(point)  # point["feat"] = [batch*3k , 64]
        return point